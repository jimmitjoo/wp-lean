...
// Autoloader — replaces 193 explicit class requires.
...
// Initialize multisite if enabled. Classes autoloaded.
if ( is_multisite() ) {
...
require ABSPATH . WPINC . '/class-wp-plugin-sandbox.php';
WP_Plugin_Sandbox::init();
